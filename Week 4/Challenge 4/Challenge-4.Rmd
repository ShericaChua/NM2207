...
# Enter code here
comm_data%>%
  mutate(sentiment_lable=case_when(
...
**Solution:** Observation has different units across each attribute, hence they cannot be measured and compared equally. Secondly, there are more then one value in each variable, hence it would be difficult to manipulate the variables.