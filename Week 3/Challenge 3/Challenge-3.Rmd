...
**Solution:**  Categoric variable: Ordinal, because emojis are type of character, also they have a natural ordering to show responses of positive, neutral and negative.
...
**Solution:**  Categoric variable: Nominal, they dont have any relationship with each other.
...
**Solution:**  Numeric variables under classification data type, because it can be manipulate the timing using numeric operators.
...
**Solution:** Character data type, as theu use a string of numerals. 
